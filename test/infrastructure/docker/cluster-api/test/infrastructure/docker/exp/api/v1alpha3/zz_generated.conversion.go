//go:build !ignore_autogenerated_capd_v1alpha3
...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*DockerMachinePoolMachineTemplate)(nil), (*v1alpha4.DockerMachinePoolMachineTemplate)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_DockerMachinePoolMachineTemplate_To_v1alpha4_DockerMachinePoolMachineTemplate(a.(*DockerMachinePoolMachineTemplate), b.(*v1alpha4.DockerMachinePoolMachineTemplate), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha4.DockerMachinePoolMachineTemplate)(nil), (*DockerMachinePoolMachineTemplate)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_DockerMachinePoolMachineTemplate_To_v1alpha3_DockerMachinePoolMachineTemplate(a.(*v1alpha4.DockerMachinePoolMachineTemplate), b.(*DockerMachinePoolMachineTemplate), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_DockerMachinePoolMachineTemplate_To_v1alpha4_DockerMachinePoolMachineTemplate(in *DockerMachinePoolMachineTemplate, out *v1alpha4.DockerMachinePoolMachineTemplate, s conversion.Scope) error {
...
// Convert_v1alpha3_DockerMachinePoolMachineTemplate_To_v1alpha4_DockerMachinePoolMachineTemplate is an autogenerated conversion function.
func Convert_v1alpha3_DockerMachinePoolMachineTemplate_To_v1alpha4_DockerMachinePoolMachineTemplate(in *DockerMachinePoolMachineTemplate, out *v1alpha4.DockerMachinePoolMachineTemplate, s conversion.Scope) error {
	return autoConvert_v1alpha3_DockerMachinePoolMachineTemplate_To_v1alpha4_DockerMachinePoolMachineTemplate(in, out, s)
}
...
// Convert_v1alpha4_DockerMachinePoolMachineTemplate_To_v1alpha3_DockerMachinePoolMachineTemplate is an autogenerated conversion function.
func Convert_v1alpha4_DockerMachinePoolMachineTemplate_To_v1alpha3_DockerMachinePoolMachineTemplate(in *v1alpha4.DockerMachinePoolMachineTemplate, out *DockerMachinePoolMachineTemplate, s conversion.Scope) error {
	return autoConvert_v1alpha4_DockerMachinePoolMachineTemplate_To_v1alpha3_DockerMachinePoolMachineTemplate(in, out, s)
}
...
func autoConvert_v1alpha3_DockerMachinePoolSpec_To_v1alpha4_DockerMachinePoolSpec(in *DockerMachinePoolSpec, out *v1alpha4.DockerMachinePoolSpec, s conversion.Scope) error {
	if err := Convert_v1alpha3_DockerMachinePoolMachineTemplate_To_v1alpha4_DockerMachinePoolMachineTemplate(&in.Template, &out.Template, s); err != nil {
		return err
	}
...
func autoConvert_v1alpha4_DockerMachinePoolSpec_To_v1alpha3_DockerMachinePoolSpec(in *v1alpha4.DockerMachinePoolSpec, out *DockerMachinePoolSpec, s conversion.Scope) error {
	if err := Convert_v1alpha4_DockerMachinePoolMachineTemplate_To_v1alpha3_DockerMachinePoolMachineTemplate(&in.Template, &out.Template, s); err != nil {
		return err
	}
	out.ProviderID = in.ProviderID
	out.ProviderIDList = *(*[]string)(unsafe.Pointer(&in.ProviderIDList))
