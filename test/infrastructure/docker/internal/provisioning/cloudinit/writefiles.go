...
// TODO: Vishwanath remove this after CAPI upgrade
...
func (a *writeFilesAction) Unmarshal(userData []byte, kindMapping Mapping) error {
...
func fixNodeRegistration(nodeRegistration *bootstrapv1.NodeRegistrationOptions, kindMapping Mapping) {
